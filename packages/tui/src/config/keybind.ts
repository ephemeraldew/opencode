...
export const Definitions = {
  ...
  agent_session_switch: keybind("tab", "Switch to the next agent's own conversation"),
  ...
  agent_cycle: keybind("shift+tab", "Next agent (shared history)"),
...
export const CommandMap = {
  ...
  agent_session_switch: "agent.session.switch",
